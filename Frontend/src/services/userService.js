...
const getAllAddressUserByUserIdService = async (userId) => {
    let res = await axios.get(`/api/get-all-address-user`, {
...
export const checkUserBoughtProductService = (userId, productId) => {
    return axios.get(`/api/check-bought?userId=${userId}&productId=${productId}`)
}
//======================STATISTIC========================//
