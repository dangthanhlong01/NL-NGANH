...
let initwebRoutes = (app) => {
    ...
    router.get('/api/check-bought', middlewareControllers.verifyTokenUser, commentController.checkUserBoughtProduct)
    //=================API STATISTIC==============================//
    ...
    router.get('/api/chatbot/welcome', chatbotController.getWelcomeMessage)
